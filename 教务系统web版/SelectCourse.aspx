<%@ Page Title="" Language="C#" MasterPageFile="~/Train.Master" AutoEventWireup="true" CodeBehind="SelectCourse.aspx.cs" Inherits="教务系统web版.SelectCourse" %>
...
<div style="font-size:20px;text-align:center;">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Nsb_r_list Nsb_table" DataKeyNames="序号" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="序号" DataNavigateUrlFormatString="SelectSourse.aspx?序号={0}" DataTextFormatString="{c:0}" HeaderText="操作" Text="选择" />
        </Columns>
    </asp:GridView>
    ...
    <asp:GridView runat="server" AutoGenerateColumns="False" CssClass="Nsb_r_list Nsb_table" DataSourceID="SqlDataSource2">
        <Columns>
            ...
            <asp:BoundField DataField="课程名称" HeaderText="课程名称" SortExpression="课程名称" />
            <asp:HyperLinkField DataNavigateUrlFields="选课号" DataNavigateUrlFormatString="SelectSourse.aspx?选课号={0}" DataTextFormatString="{c:0}" HeaderText="操作" Text="退选" />
        </Columns>
    </asp:GridView>
