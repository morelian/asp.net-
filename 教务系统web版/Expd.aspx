<%@ Page Title="" Language="C#" MasterPageFile="~/Practice.Master" AutoEventWireup="true" CodeBehind="Expd.aspx.cs" Inherits="教务系统web版.Expd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="Nsb_r_title"><a href="Desk.aspx">首页</a>>>实验教学>>实验预约管理(已选)</div>
<div style="font-size:20px;text-align:center;">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Nsb_r_list Nsb_table" DataKeyNames="项目编号" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:HyperLinkField AccessibleHeaderText="" DataNavigateUrlFields="项目编号" DataNavigateUrlFormatString="Exp.aspx?项目编号={0}" DataTextFormatString="{c:0}" HeaderText="操作" Text="退选" />
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EduJWConnectionString %>" SelectCommand="SELECT E.No AS '项目编号',E.Name AS '实验项目名称',ET.Name AS '项目类型',E.Length AS '计划学时',L.Name AS '承担实验室',F.Name AS '负责教师'  FROM tb_ExperimentSd AS Ed
